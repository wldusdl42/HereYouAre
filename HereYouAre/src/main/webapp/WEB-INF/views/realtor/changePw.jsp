      ...
      <div class="content" style="padding-top:0px;">
        <div class="container-fluid">
        	<form method="post" action="checkcheck">
				<p class="tip" style="margin-top:0px; margin-bottom:15px;">비밀번호 변경</p>
				<div class="cont">
				  	<div class="row" style="width:70%; margin-left:auto;margin-right:auto;margin-top:16vh;">
	                      <div class="col-md-12" >
		                        <div class="form-group">
		                          <label class="bmd-label-floating">새비밀번호</label>
	                      ...
	                      <div class="col-md-12">
		                        <div class="form-group">
		                          <label class="bmd-label-floating">비밀번호확인</label>
		                          <input type="password" class="form-control" name="password">
		                          
		                        </div>
	                      </div>
	                      <p style="color:red;height:auto; margin-left:14px;">${result}</p>
	                       <button type="submit" class="btn btn-primary pull-right" style="margin-left:15px; margin-top:30px;">Update</button>
                    </div>
				</div>
        	</form>
        </div>
